...
function devlife_wp_setup() {
    add_theme_support( 'title-tag' );
}

add_action( 'after_setup_theme', 'devlife_wp_setup' );

function devlife_enqueue_styles() {
    ...
    wp_enqueue_style( 'devlife-style', get_stylesheet_uri(), array('google-fonts', 'highlight') ); 

}

function devlife_enqueue_scripts() {
...
add_action( 'wp_enqueue_scripts', 'devlife_enqueue_styles' );
add_action( 'wp_enqueue_scripts', 'devlife_enqueue_scripts' );
